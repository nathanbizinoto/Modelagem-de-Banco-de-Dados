create database colegio_jupiter;
use colegio_jupiter;
CREATE TABLE [aluno] (
...
SELECT * FROM aluno;
INSERT INTO aluno (id_aluno, nome, data_nac, rua, numero, bairro, cidade)
VALUES (21, 'Nome Aluno', '2000-01-01', 'Rua X', 123, 'Bairro Y', 'Cidade Z');
...
WHERE id_aluno = 17;
 ...
 SELECT * FROM turma WHERE periodo like 'noturno'

  /*3 - Selecione todos os alunos da Cidade B*/

  SELECT * FROM aluno WHERE cidade like 'Cidade B'
  ...
  SELECT * from disciplina WHERE carga_horaria > '30'
   ...
   /*5- Selecione todas as disciplinas*/
     SELECT * from disciplina

/*7 - Selecione as disciplinas com 45 de carga horaria*/
	SELECT * from disciplina where carga_horaria like '45'

/*8 - Selecione os alunos nascidos em 1999 e 2001*/
	SELECT * FROM aluno where data_nac > '1998-12-31' and data_nac < '2002-01-01'

/*9 - Selecione os alunos nascidos em 2001 na Cidade A*/
	SELECT * FROM aluno where data_nac > '2000-12-31' and data_nac <'2002-01-01' and cidade like 'Cidade A'
